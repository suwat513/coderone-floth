...
3rd place from [Dungeons & Data Structures: Coder One AI Sports Challenge](https://github.com/gocoderone/dungeons-and-data-structures)

BIO: Floth - The fastest ~Sloth~ (The Three toes Assassin!)
...
- Add some special check for bomb and ore block
- Kill the slow starter and Assassinate when there is a chance!!!!

Note: I haven't clean up the code might be a bit hard to read

### Floth Version
- scrim1_floth.py (initial version for testing the strategy)
- scrim2_floth.py (redo the whole core strategy from scenario based to point based)
- after_scrim2_floth.py (bug fix for bomb tick checking)
- floth.py (bug fix for ore block hp checking)
...
> pip install ~/Downloads/coderone-challenge-dungeons-0.1.5.tar.gz
